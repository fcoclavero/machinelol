...
import recomendation._logsystem as logsys
            ...
            for fileDir in os.listdir(dir):
                ...
                for char in self.characteristics:
                    ...
                    if char == 'wins':
                        ...
                        try:
                            aux[char] = (
                                data[normalIndex][u"aggregatedStats"][uchar] + data[rankedIndex][u"aggregatedStats"][uchar])
                        except:
                            try:
                                aux[char] = (
                                    data[normalIndex][u"aggregatedStats"][uchar])
                            except:
                                aux[char] = (data[rankedIndex][u"aggregatedStats"][uchar])
                #except:
                #    continue
